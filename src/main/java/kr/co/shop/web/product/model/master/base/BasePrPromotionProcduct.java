...
@Data
public class BasePrPromotionProcduct extends BaseBean implements Serializable {

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 프로모션번호
	 */
	private String promoNo;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 프로모션명
	 */
	private String promoName;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 프로모션유형코드
	 */
	private String promoTypeCode;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 프로모션시작일시
	 */
	private java.sql.Timestamp promoStartDtm;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 프로모션종료일시
	 */
	private java.sql.Timestamp promoEndDtm;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 재고차감유형
	 */
	...
	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 :
	 */
	...
	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 정상가
	 */
	...
	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 기간계할인율
	 */
	private java.lang.Short erpDscntRate;

	/**
	 * 이 필드는 Code Generator를 통하여 생성 되었습니다. 설명 : 온라인할인율
	 */
