...
import kr.co.shop.web.display.repository.master.base.BaseDpWebzineDetailImageDao;
...
public interface DpWebzineDetailImageDao extends BaseDpWebzineDetailImageDao {
     ...
     * BaseDpWebzineDetailImageDao는 절대 수정 불가 하며 새로운 메소드 추가 하실 경우에는 해당 소스에서 작업 하시면 됩니다.
     * 
     */
