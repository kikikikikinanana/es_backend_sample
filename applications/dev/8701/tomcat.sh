...
export CATALINA_BASE=/home/abcmart/apps/project/abcmart/was/tomcat/shop.backend2
...
# 포트 및 로그 경로 지정.
export JAVA_OPTS="$JAVA_OPTS -Dserver.port=8701" 
export JAVA_OPTS="$JAVA_OPTS -Djava.net.preferIPv4Stack=true" 
export JAVA_OPTS="$JAVA_OPTS -Dlog.path=/home/abcmart/apps/project/abcmart/was/tomcat/shop.backend2/logs" 
